...
import { Heart, Send, Inbox, SendHorizontal, Loader2, Mail, MailOpen, Sparkles } from 'lucide-react';
        ...
        >
            <Card 
                className={`border-border/50 shadow-soft transition-all ${
                    isReceived && !note.is_read ? 'bg-primary/5 border-l-4 border-l-primary' : ''
                }`}
        ...
        <div className="space-y-6" data-testid="love-notes-page">
            ...
            <Card className="border-border/50 shadow-card">
                <CardContent className="p-4 space-y-4">
                    <Textarea
                        placeholder={`Write something sweet for ${user?.partner_name?.split(' ')[0]}...`}
                        value={message}
                        ...
                        {EMOJI_OPTIONS.map((emoji) => (
                            <button
                                ...
                                className={`text-2xl p-1 rounded-lg transition-all ${
                                    selectedEmoji === emoji ? 'bg-primary/20 scale-110' : 'hover:bg-muted'
                                }`}
            ...
            <Tabs defaultValue="received" className="w-full">
                <TabsList className="grid w-full grid-cols-2 mb-4">
                    <TabsTrigger value="received" className="relative" data-testid="tab-received">
                        Received
                        {unreadCount > 0 && (
                            ...
                            <Card className="border-border/50">
                                <CardContent className="p-8 text-center">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Notes from {user?.partner_name?.split(' ')[0]} will appear here
                                    </p>
                                </CardContent>
                            </Card>
                        ) : (
